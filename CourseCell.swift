...
let TITLEFONT = UIFont.systemFont(ofSize: 16.0)
...
class CourseCell: UITableViewCell {
    ...
    func initialize(){
        ...
        updateTime.backgroundColor = UIColor.clear
        updateTime.textColor = UIColor(red: 175/255,
                                  green: 186/255,
                                  blue: 202/255,
                                  alpha: 1)
    ...
    override func layoutSubviews() {
        ...
        self.title.frame = CGRect(x: WHRatio*CELLHEIGHT+MARGIN*2, y: CELLHEIGHT/4, width: ScreenHeight-WHRatio*CELLHEIGHT+MARGIN-20, height: 20.0)
        self.autor.frame = CGRect(x: WHRatio*CELLHEIGHT+MARGIN*2, y: CELLHEIGHT*2/4, width: ScreenHeight-WHRatio*CELLHEIGHT+MARGIN-20, height: 20.0)
        self.updateTime.frame = CGRect(x: WHRatio*CELLHEIGHT+MARGIN*2, y: CELLHEIGHT*3/4, width: ScreenHeight-WHRatio*CELLHEIGHT+MARGIN-20, height: 20.0)
    }
